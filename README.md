...
🚀 Desenvolvedor focado em Web, Automação e Dados  
🏢 Atuando em tecnologia no contexto corporativo (Votorantim Cimentos)

---

## 🧠 Sobre mim

Sou engenheiro de computação com background técnico sólido em desenvolvimento de software, automação de processos e análise de dados.  
Atuo hoje em um ambiente corporativo de alta escala, trabalhando com sistemas, indicadores, dados e integração entre áreas de negócio.

Tenho forte afinidade com desenvolvimento web, backend e soluções orientadas a dados.
...
**Dados & Automação**
- MySQL • Power BI • Power Automate • Excel • APIs

**Infra & Sistemas**
- Linux • Git • GitHub • Redes • Segurança da Informação
...
|--------|---------|------|
| Web Portal | Portal web com autenticação e frontend moderno | HTML, CSS, JS, React |
| Backend API | API para sistemas web e automações | PHP / Python, SQL |
| Data Automation | Scripts e pipelines para dados corporativos | Python, SQL |
| Algorithms | Lógica e estruturas em C/C++ | C, C++ |

*(em breve links individuais para cada projeto)*
